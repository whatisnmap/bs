...
/* ---------- */
/* Media */
const logoUrl = 'img/logo-2.png'; // Logo image
const backgroundUrl = 'img/bg-2.jpg'; // Background image
...
var R1N = " <img src='img/firstResource.png' class='status-img'>" + R111_ODMIENIONE;
var R2N = " <img src='img/secondResource.png' class='status-img'>" + R222_ODMIENIONE;
var PS = "";
...
const hackheader = `Get ${GN} <img src='img/secondResource.png' class='flick-img' alt="r-2"> ${R222} and <img src='img/firstResource.png' class='flick-img' alt="r-1"> ${R111}`;
...
const bothchoice = `How many <img src='img/firstResource.png' class='status-img mr-0' alt="r-1"> ${R111} and <img src='img/secondResource.png' class=status-img mr-0 alt="r-2"> ${R222} do you want?`
